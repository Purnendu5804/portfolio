...
| **Page Sections** | HeroSection, SkillSection, Experience, Projects, AllProjects, UsesSection, ContactMe, Footer, Calendar |
...
Footer with quote, copyright, and visitor counter.

| Prop | Type | Default | Description |
|------|------|---------|-------------|
| — | — | — | No props |

**Internal hook:** `useVisitorCounter()` → `{ visitorCount, loading }`
