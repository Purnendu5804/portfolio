...
| Backend/DB | Firebase (Firestore) | 12.2.1 |
...
│   │   ├── footer/         # Footer with visitor counter
...
│   │   └── visitorService.ts # Visitor count CRUD
│   ├── hooks/
│   │   └── useVisitorCounter.ts # Visitor counter hook
│   ├── pages/
...
3. **No data fetching library** — Firebase SDK used directly, no React Query/SWR
